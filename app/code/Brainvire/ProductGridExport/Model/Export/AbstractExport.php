...
namespace Brainvire\ProductGridExport\Model\Export;
...
abstract class AbstractExport
{
    ...
    {
        if (!empty($this->fieldMappingOptions[$mappingField])) {
    ...
    protected function getHeaders(UiComponentInterface $component, array $sortedMapping): array
    {
        ...
        return array_map(static function ($field) use ($headerFieldMapping) {
