...
return [
    'modules' => [
        ...
        'Magento_ConfigurationDataExporter' => 1,
        'Magento_Contact' => 1,
        'Magento_Cookie' => 1,
        'Magento_Cron' => 1,
        'Magento_Csp' => 1,
        ...
        'Magento_B2b' => 1,
        'Magento_ExperienceConnectorAepIntegration' => 1,
        ...
        'Magento_ExperienceConnectorAdmin' => 1,
        ...
        'Magento_ProductReviewDataExporter' => 1,
        ...
        'Magento_SaaSRMASync' => 1,
        'Magento_SaaSSales' => 1,
        'Magento_ScopesDataExporter' => 1,
        'Magento_SaasCommerceEventingCommon' => 1,
        ...
        'Magento_ExperienceConnectorAdminGraphQl' => 1,
        'Magento_ExperienceConnector' => 1,
        ...
        'Amasty_Base' => 0,
        'Amasty_Pgrid' => 0,
        'Aureatelabs_NewProductType' => 0,
        'Brainvire_AchPayment' => 1,
        'Brainvire_Addimage' => 1,
        'Brainvire_ContactForm' => 1,
        'Brainvire_Custom' => 0,
        'Brainvire_CustomComponent' => 1,
        'Brainvire_CustomIndexer' => 1,
        'Brainvire_CustomProductType' => 1,
        'Brainvire_CustomSlider' => 0,
        'Brainvire_CustomSystem' => 0,
        'Brainvire_CustomWork' => 1,
        'Brainvire_DemoPatch' => 1,
        'Brainvire_Extrapdf' => 1,
        'Brainvire_FirstGraphql' => 1,
        'Brainvire_FormField' => 1,
        'Brainvire_HelloWorld' => 0,
        'Brainvire_Imageadd' => 1,
        'Brainvire_Paymentadd' => 0,
        'Brainvire_ProductCustomize' => 0,
        'Brainvire_ProductGridExport' => 1,
        'Brainvire_ProductImport' => 1,
        'Brainvire_Projects' => 1,
        'Brainvire_RestApiDemo' => 1,
        'Brainvire_Rfq' => 1,
        'Brainvire_SampleGrid' => 0,
        'Brainvire_Uiforms' => 1,
        'Brainvire_Validmail' => 0,
        'Brainvire_Widget' => 1,
        'Brainvire_Widgetplus' => 0,
        'Company_Vendor' => 1,
        'Customer_Event' => 0,
        'Customer_CronExample' => 1,
        'Customer_CustomEvent' => 1,
        'Customer_CustomField' => 1,
        'Customer_CustomWidget' => 0,
        'Customer_Customroute' => 1,
        'Customer_Dataphoto' => 0,
        'Customer_Login' => 0,
        'Customer_ExtendCheckout' => 0,
        'Customer_ExtraField' => 1,
        'Database_Check' => 0,
        'Customer_NewWidget' => 0,
        'Customer_ProxyExample' => 1,
        'Customer_Require' => 1,
        'Customer_RestApi' => 0,
        'Customer_SimpleComponent' => 1,
        'Customer_SliderEx' => 0,
        'MD_Helloworld' => 1,
        'Devhooks_HelloWorld' => 1,
        'EmizenTech_InvoicePdfimage' => 0,
        'Customer_Addblock' => 0,
        'Magepow_Core' => 1,
